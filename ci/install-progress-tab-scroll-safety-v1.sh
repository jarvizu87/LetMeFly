...
grep -Fq 'const refreshFinalize=()=>window.__LMF_PROGRESS_FINALIZE__?.refresh?.()' "$PROGRESS_JS"
grep -Fq 'window.setTimeout(refreshFinalize,420)' "$PROGRESS_JS"
