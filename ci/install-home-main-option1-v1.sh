...
# Direct primary-nav bridge must preserve both approved first-class destinations.
grep -Fq "datasetKey: 'lmfDirectExercises'" "$NAV_SRC"
grep -Fq "href: '#/exercises'" "$NAV_SRC"
grep -Fq "datasetKey: 'lmfDirectCoach'" "$NAV_SRC"
...
grep -Fq 'lmfDirectExercises' "$JS_OUT"
grep -Fq "#/exercises" "$JS_OUT"
grep -Fq 'lmfDirectCoach' "$JS_OUT"
grep -Fq "#/coach" "$JS_OUT"
