...
const checks = [
  ...
  ['update controller base asset is precached', sw.includes("'/ui/pwa-update-v1.js'")],
  ['exact versioned update controller URL is precached', sw.includes("'/ui/pwa-update-v1.js?v=1'")],
