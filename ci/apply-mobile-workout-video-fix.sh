...
EDGE_FLOW_CSS="$ROOT_DIR/overlays/ui-command-v2/batch-u/workout-flow-edge-audit-v1.css"
...
cat "$EDGE_FLOW_CSS" >> "$TARGET_DIR/src/command-v2.css"
...
grep -Fq 'restGateByPanel' "$TARGET_DIR/public/ui/workout-flow-v1.js"
grep -Fq 'data-lmf-rest-continue' "$TARGET_DIR/public/ui/workout-flow-v1.js"
grep -Fq 'cards.length < 2' "$TARGET_DIR/public/ui/workout-flow-v1.js"
grep -Fq 'scrollIntoView' "$TARGET_DIR/public/ui/workout-flow-v1.js"
grep -Fq 'Load / bodyweight as prescribed' "$TARGET_DIR/public/ui/workout-flow-v1.js"
...
grep -Fq 'lmf-pwa-install-dismissed-v1' "$TARGET_DIR/public/ui/pwa-install.js"
