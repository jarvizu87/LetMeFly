...
assert(index.includes('/ui/locked-art-fidelity-v1.css?v=7'), 'index missing current locked art fidelity stylesheet')
...
assert(sw.includes('-locked-ui-v8'), 'service worker must refresh the previously cached UI assets')
