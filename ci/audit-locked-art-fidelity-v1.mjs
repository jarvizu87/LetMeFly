...
assert(index.includes('/ui/locked-art-fidelity-v1.css?v=4'), 'index missing current locked art fidelity stylesheet')
...
assert(sw.includes('-locked-ui-v4'), 'service worker must refresh the previously cached UI assets')
