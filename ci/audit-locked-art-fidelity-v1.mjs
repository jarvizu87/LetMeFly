...
assert(sw.includes('-locked-ui-v24'), 'service worker must refresh the previously cached UI assets')
...
assert(index.includes('/ui/train-block-cards-v1.css?v=4') && sw.includes('/ui/train-block-cards-v1.css?v=4'), 'The block-card layout is installed and cached')
