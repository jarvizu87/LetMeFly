...
// Weeks 13-14 are testing/handoff and must not receive the W1-12 primer change.
for (const week of [13, 14]) {
  const text = read(`src/programs/crownforge/weeks/week-${week}.ts`)
  assert(!text.includes('Conditional technique primer only'), `Week ${week} received out-of-scope v2.2 primer note`)
}

// Separate programs remain byte-for-byte protected by the installer marker.
